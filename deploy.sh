...
aws s3 mv "s3://$BUCKET/$PREFIX/brython_stdlib.3.8.0.js" "s3://$BUCKET/$PREFIX/brython_stdlib.3.8.0.js_old"
aws s3 mv "s3://$BUCKET/$PREFIX/brython_stdlib.js" "s3://$BUCKET/$PREFIX/brython_stdlib.js_old"
aws s3 mv "s3://$BUCKET/$PREFIX/brython.3.8.0.js" "s3://$BUCKET/$PREFIX/brython.3.8.0.js_old"
aws s3 mv "s3://$BUCKET/$PREFIX/brython.js" "s3://$BUCKET/$PREFIX/brython.js_old"
